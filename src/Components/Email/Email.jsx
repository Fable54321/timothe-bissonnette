...
const Email = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (errors.name || errors.email || errors.phone || errors.message || name === '' || email === '' || phone === '' || message === '' || !checked) {
      return
    }
    else{
     ...
     className={styles["contact"]}>
      ...
      <Confirmation setConfirmed={setConfirmed} />
        ...
        <div className={styles["contact__form--group"]}>
          ...
          <div className={styles['contact__form--group']}>
            <label htmlFor="checkbox" className={styles["contact__form__checkbox"]}>
            Je consens à recevoir des communications par courriel de tb-technologies-support@tb-technologies.ca //
            <br/> I consent to receive email communications from tb-technologies-support@tb-technologies.ca
              <input
                type="checkbox"
                id="checkbox"
                value={checked}
